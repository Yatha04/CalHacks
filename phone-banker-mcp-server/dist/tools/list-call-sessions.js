...
exports.listCallSessionsTool = void 0;
exports.listCallSessions = listCallSessions;
const supabase_client_js_1 = require("../utils/supabase-client.js");
exports.listCallSessionsTool = {
...
async function listCallSessions(args) {
    const { userId, limit = 10, status } = args;
    let query = supabase_client_js_1.supabase
        .from("call_sessions")
        .select("*")
...
//# sourceMappingURL=list-call-sessions.js.map